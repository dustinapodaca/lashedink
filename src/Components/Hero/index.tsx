        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center">
            <h1
              ...
              className="font-london text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-white text-center mx-32 sm:mx-10"
            >
              Enhance Your Beauty
            </h1>
            <p
              className="max-w-5xl font-light text-white text-md sm:text-lg lg:text-xl xl:text-2xl mt-8 text-center mx-8"
              style={{
